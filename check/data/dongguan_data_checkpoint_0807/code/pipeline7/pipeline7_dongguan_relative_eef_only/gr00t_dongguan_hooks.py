"""Pipeline7 hooks: sync action-head state_history_length with delta_indices [-7,-1,0]."""
...
def _resize_action_head_state_history(model, target_length: int) -> None:
    ...
    logging.info(
        "[pipeline7_dongguan] resizing state_history_length %s -> %s "
...
def install_dongguan_state_history_hooks(*, state_history_length: int) -> None:
    ...
    patched_create_model._pipeline7_dongguan_state_history_patch = True
