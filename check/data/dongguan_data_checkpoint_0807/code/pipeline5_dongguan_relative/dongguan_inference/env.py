"""GR00T import/env setup for Dongguan pipeline5 inference."""
...
from dongguan_inference.constants import COSMOS_MODEL, GR00T_REPO, PIPELINE2, PIPELINE3, PIPELINE5


def setup_gr00t_env() -> dict[str, str]:
    env = os.environ.copy()
    pipeline_paths = [str(GR00T_REPO), str(PIPELINE5), str(PIPELINE3), str(PIPELINE2)]
...
def ensure_dongguan_infer_imports() -> None:
    ...
    from dongguan_inference.gr00t_dongguan_infer_hooks import install_dongguan_qlora_infer_hooks
    ...
    import dongguan_relative_modality  # noqa: F401
