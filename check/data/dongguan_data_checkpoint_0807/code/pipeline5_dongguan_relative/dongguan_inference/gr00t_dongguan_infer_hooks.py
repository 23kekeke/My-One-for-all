"""Pipeline5 QLoRA infer load: ViT+LLM LoRA and state_history_length from checkpoint."""
...
def _resize_action_head_state_history(model, target_length: int) -> None:
    ...
    print(
        "[pipeline5_dongguan_infer] resizing state_history_length "
...
def install_dongguan_qlora_infer_hooks() -> None:
    """Patch pipeline5 load_qlora_finetuned_model for checkpoint state_history_length."""
    import gr00t_qlora_hooks as qlora_hooks

    if getattr(qlora_hooks.load_qlora_finetuned_model, "_pipeline5_dongguan_infer_patch", False):
        return

    orig_load = qlora_hooks.load_qlora_finetuned_model
    ...
    def patched_load_with_resize(
        ...
        *,
        ...
        print(
            "[pipeline5_dongguan_infer] QLoRA infer load with state_history_length="
    ...
    patched_load_with_resize._pipeline5_dongguan_infer_patch = True
